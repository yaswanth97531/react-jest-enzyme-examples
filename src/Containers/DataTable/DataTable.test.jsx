...
it('renders in table rows based on provided columns', () => {
  // By using the snapshotSerializers there is no need for us to convert the component to JSON manually. It automatically does it.
...
describe('<DataTable /> rendering', () => {
  it("should render 'There is no data in the table'", () => {
    const wrapper = shallow(<DataTable data={[]} cols={[]} />);
    const text = wrapper.find('td').text();
    expect(text).toEqual('There is no data in this table');
  });
});
